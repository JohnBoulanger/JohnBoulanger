...
- **Full-Stack Development** → Production React + Node.js/Express apps with auth, real-time features, and role-based access
- **Machine Learning** → Multi-sensor inference pipelines, CNNs, Transformers, and model evaluation
- **Data Engineering** → Dashboards, automation tools, and ETL for messy real-world datasets
...
Geographic mapping application visualizing road networks and POIs for cities worldwide. Implemented A* pathfinding over real-world road graphs, computing optimal routes across city-scale datasets with tens of thousands of intersections.
...
![Claude](https://img.shields.io/badge/-Claude-D4A27F?logo=anthropic&logoColor=white&style=flat)
